...
public class HRManagerBankExportController {

    private final BankExportService bankExportService;

    @GetMapping("/hrmanager/payroll-periods/{periodId}/export-bank")
    ...
    public void exportBankFile(
        ...
        try {
            ...
            response.sendRedirect("/hrmanager/payroll-review/" + periodId);
        } catch (Exception e) {
