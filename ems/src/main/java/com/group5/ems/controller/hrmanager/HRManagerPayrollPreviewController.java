...
/**
 * Controller for the Payroll Preview dashboard (HRManager).
 * Provides paginated aggregated view of attendance, bonuses, and deductions per period.
 */
@Controller
@RequestMapping("/hrmanager/payroll-preview")
@PreAuthorize("hasAnyRole('ADMIN', 'HR_MANAGER')")
@RequiredArgsConstructor
public class HRManagerPayrollPreviewController {
    ...
    public String previewPeriod(@PathVariable Long periodId,
        ...
        try {
            ...
            return "hrmanager/payroll_preview";
    ...
    public String generatePayslips(@PathVariable Long periodId,
        ...
        return "redirect:/hrmanager/payroll-preview/" + periodId;
    }
}
